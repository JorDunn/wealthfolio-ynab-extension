...
## [0.2.0](https://github.com/JorDunn/wealthfolio-ynab-extension/compare/v0.1.0...v0.2.0) (2026-07-20)


### Features

* stage 3 sync core — YNAB client, mapping layer, sync engine (TDD) ([1290867](https://github.com/JorDunn/wealthfolio-ynab-extension/commit/1290867a7fa901802beb11798424124a9abfd51b))
* stage 4 UI — sync page, mapping table, settings, smoke tests ([32a9502](https://github.com/JorDunn/wealthfolio-ynab-extension/commit/32a95026f45ed34c4238a238fc29fe6ebbb2bf6b))


### Bug Fixes

* stage 6 — manifest permissions shape, packaging, and install docs ([d28cbf7](https://github.com/JorDunn/wealthfolio-ynab-extension/commit/d28cbf717339f4e320ff4b59006893991bf6b8c4))
